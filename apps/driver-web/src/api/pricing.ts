...
export function setPricing(listingId: string, rules: PricingRuleInput[], effectiveFrom?: string): Promise<PricingVersion> {
  return apiRequest(`/v1/host/listings/${listingId}/pricing`, { method: "PUT", body: { rules, effectiveFrom } });
}
